...
object Deps {
    ...
    private const val kotlinTestVersion = "1.4.30-M1"
    // should be as kotlin version! see buildSrc/build.gradle.kts
    private const val kotlinxSerializationPluginVersion = "1.4.30-M1"
    ...
    private const val mokoGraphicsVersion = "0.5.1"
    private const val mokoParcelizeVersion = "0.5.1"
    ...
    private const val mokoNetworkVersion = "0.8.1"
    private const val mokoUnitsVersion = "0.4.2"
    private const val mokoPermissionsVersion = "0.6.1"
    private const val mokoMediaVersion = "0.5.1"
    private const val mokoFieldsVersion = "0.5.1"
